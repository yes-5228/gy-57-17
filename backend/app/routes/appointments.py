...
from app.services.appointments import cancel_appointment, check_in_appointment, create_appointment, list_appointments
...
def check_in(appointment_id: int) -> AppointmentRead:
    return check_in_appointment(appointment_id)
